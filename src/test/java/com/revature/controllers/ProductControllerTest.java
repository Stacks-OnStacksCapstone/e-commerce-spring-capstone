...
public class ProductControllerTest {
    ...
    public void testGetAllProducts() throws Exception {
        int[] orders = {0, 1, 2, 3, 4, 5, 6, 7, 8};
        int[] productIDs = {1, 2, 3, 4, 5, 6, 7, 8, 9};
        int[] quantity = {10, 5, 16, 20, 3, 10, 5, 20, 1};
        double[] price = {20.0, 45.0, 2.5, 10.0, 80.0, 120.0, 99.99, 12.5, 1000.0};
        String[] descriptions = {
    ...
    public void testDeleteProduct() throws Exception {
        this.mockMvc
                ...
                .andExpect(MockMvcResultMatchers.jsonPath(".image").value("https://media.bergdorfgoodman.com/f_auto,q_auto:good,ar_5:7,c_fill,dpr_1.0,w_720/01/bg_4370145_100664_m"))
