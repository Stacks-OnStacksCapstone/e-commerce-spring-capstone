...
import static com.revature.stepsImplementation.orderhistory.OrderHistoryHooks.productDetailsPage;
import static com.revature.stepsImplementation.orderhistory.OrderHistoryHooks.wait;
...
public class OrderHistorySteps {
    ...
    public void user_is_on_login_page() {
        OrderHistoryHooks.driver.get("http://localhost:3000/login");
    }

    @When("User enters an email")
    public void user_enters_an_email() {
        OrderHistoryHooks.loginPage.emailInput.sendKeys("jane@gmail.com");
    }

    @When("User enters a password")
    public void user_enters_a_password() {
        OrderHistoryHooks.loginPage.passwordInput.sendKeys("password");
    }

    @When("User clicks login")
    public void user_clicks_login() {
        OrderHistoryHooks.loginPage.loginButton.click();
    }

    @Then("User logs in to Front page")
    public void user_logs_in_to_front_page() {
        wait.until(ExpectedConditions.urlToBe("http://localhost:3000/"));
        String actual = OrderHistoryHooks.driver.getCurrentUrl();
    ...
    public void user_clicks_the_orders_link() {
        ...
        OrderHistoryHooks.frontPage.ordersButton.click();
    }
    ...
    public void user_can_see_the_order_date_and_total_of_each_order() {
        ...
        String actualDate = OrderHistoryHooks.orderPage.orderDate.getText();
        String actualTotal = OrderHistoryHooks.orderPage.orderTotal.getText();
    ...
    public void user_can_view_the_order_detail_id_and_order_id() {
        ...
        String actualOrderDetailId = OrderHistoryHooks.orderPage.capOrderDetailId.getText();
        String actualOrderId = OrderHistoryHooks.orderPage.capOrderId.getText();
    ...
    public void user_can_view_the_product_purchased() {
        ...
        String actualProd = OrderHistoryHooks.orderPage.capLink.getText();
        String actualDesc = OrderHistoryHooks.orderPage.capDescription.getText();
    ...
    public void user_can_view_the_product_id_and_quantity_of_the_product_purchased() {
        ...
        String actualProductId = OrderHistoryHooks.orderPage.capProductId.getText();
        String actualQuantity = OrderHistoryHooks.orderPage.capQuantity.getText();
    ...
    public void user_clicks_on_the_name_of_a_product_from_a_previous_order() {
        ...
        OrderHistoryHooks.orderPage.capLink.click();
    }
    ...
    public void the_review_is_removed_from_the_product_reviews() {
        wait.until(ExpectedConditions.textToBe(By.xpath("//div[@id='root']/div[2]/div[3]/div[3]//p"), "No reviews.."));
        //String actual = productDetailsPage.productReviews.getText();
        String actual = productDetailsPage.noReviewsMessage.getText();
    ...
    public void user_sees_their_rating_and_review_added_to_the_product_reviews() {
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@id='root']/div[2]/div[3]/div[3]/div")));
        String actual = productDetailsPage.productReviews.getText();
